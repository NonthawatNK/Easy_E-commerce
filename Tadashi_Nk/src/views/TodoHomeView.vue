...
<template>
    <div>
        <div class="flex">
            <input class="input input-bordered w-full " type="text" v-model="todoText" placeholder="Iteme name here...">
            <button class="btn btn-primary ml-3" @click="addTodo(todoText)">Add</button>
        </div>
        <Loading v-if="isLoading"></Loading>
        <div class="tabs tabs-boxed mt-4">
            <a v-for="status in todoStore.status" :class="status === selectedStatus ? 'tab tab-active' : 'tab'"
